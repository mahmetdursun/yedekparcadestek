...
export const MOCK_PRODUCTS = [
...

 {
  ...
  title: "Vantilatör Kayışı RENAULT",
  brand: "BANDO",
  ...
  ean: "8200830196",
  categories: [
    { label: "Tahrik / V Kayışları", href: "/k/kayis" },
  ],
  attributes: [
  ...
  fitment: [
    { brand: "Renault", model: "Clio III", years: "2005–2014" },
    { brand: "Renault", model: "Clio IV", years: "2012–2019" },
    { brand: "BMW", model: "7 Serisi (E38)", years: "1994–2001" },
  ],
